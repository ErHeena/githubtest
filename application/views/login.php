...
<body>
    <?php //if($loginData){ $formAction = base_url('views/dashboard.php'); }else{ $formAction = '#'; }?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="">
                                    <span> <img src="<?= base_url('assets/images/logo-light.jpg'); ?>" alt="" height="50"></span>
                                </a>
                                <p class="text-muted mb-4 mt-3">Enter your email address and password to access admin
                                    panel.</p>
                            </div>

                            <form action="<?php echo base_url('index.php/login/getUserData'); ?>" method="POST">

                                <div class="form-group mb-3">
                                    <label for="emailaddress">Email address</label>
                                    <input class="form-control" name="email" type="email" id="" placeholder="Enter your email">
                                </div>
